...
std::vector<VkDescriptorSetLayout> layouts(MAX_FRAMES_IN_FLIGHT, descriptorInfo.descriptorSetLayout);
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            descriptorWrites[0].dstSet = descriptorInfo.descriptorsSets[i];
            ...
            descriptorWrites[1].dstSet = descriptorInfo.descriptorsSets[i];
...
void createDescriptorPool(VkDevice& device, VkDescriptorPool& descriptorPool)
{
  ...
  if (vkCreateDescriptorPool(device, &poolInfo, nullptr, &descriptorPool) != VK_SUCCESS) 
    GenLogCritical("Failed to create descriptor pool! In descriptorsetLayout.cpp:createDescriptorPool");
...
void createDescriptorSetLayout(VkDevice& device, VkDescriptorSetLayout& descriptorLayout, VkPipelineLayout& pipelineLayout)
{
  ...
  if (vkCreateDescriptorSetLayout(device, &layoutInfo, nullptr, &descriptorLayout) != VK_SUCCESS) 
    GenLogCritical("Failed to create descriptor set layout in descriptorsetLayout.cpp:createDescriptorSetLayout");
}
